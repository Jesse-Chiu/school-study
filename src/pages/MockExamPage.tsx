        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm text-amber-700/90 leading-relaxed">
              抱歉，目前题库中部分题目的图片信息可能存在错乱或缺失，建议您下载原版PDF获取准确完整的试卷内容。我们会持续完善题库质量，感谢您的关注与支持！
            </p>
          </div>
          <a
            href={`${import.meta.env.BASE_URL}downloads/pingdong-2025-biology.pdf`}
            download
            className="flex-shrink-0 inline-flex items-center gap-2 px-4 py-2.5 bg-white border border-amber-300 rounded-lg text-amber-700 hover:bg-amber-50 hover:border-amber-400 transition-all text-sm font-medium shadow-sm whitespace-nowrap"
          >
            <Download size={18} />
